...
public class JdbcConnectionPooling
{
	...
	private static JdbcConnectionPooling instance = null;
	 ...
	 * @throws SQLException
	 */
	private JdbcConnectionPooling()
			throws SQLException 
	{
		try 
		{
			// Import DB configuration
			PropertyConfig settings = new PropertyConfig();
	 ...
	 * @throws SQLException
	 */
	public static JdbcConnectionPooling get_instance()
			throws SQLException
	{
		if (instance == null)
		{
			instance = new JdbcConnectionPooling();
		}
